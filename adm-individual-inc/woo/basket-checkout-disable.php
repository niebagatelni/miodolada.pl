...
function get_login_register_buttons($class = 'button', $style = 'inline') {
    ...
    if (!is_user_logged_in()) {
        ...
        // Użytkownik zalogowany ale z rolą "zainteresowany_oferta"
        if ($style === 'block') {
...
/*
// 2. LISTA PRODUKTÓW - zamiana guzika "Dodaj do koszyka"
...
// 12. KOMUNIKAT W KOSZYKU - informacyjny, nie blokujący
...
// 13. BLOKOWANIE QUICK VIEW (jeśli używasz takiej wtyczki)
...
/*
// 18. LOG AKTYWNOŚCI (opcjonalnie - do debugowania)
